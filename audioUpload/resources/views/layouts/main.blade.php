      ...
      @foreach ($houses as $house)
        <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
          ...
          <div class="relative pb-48 overflow-hidden">
            <img class="absolute inset-0 h-full w-full object-cover" src="/storage/profil_images/{{$house->image}}" alt="">
          </div>
          <div class="p-4">
            ...
            <h2 class="mt-2 mb-2  font-bold">{{$house->place}}</h2>
            <p class="text-sm">{{$house->description}}</p>
            <div class="mt-3 flex items-center">
              <span class="text-sm font-semibold">ab</span>&nbsp;<span class="font-bold text-xl">{{$house->price}}</span>&nbsp;<span class="text-sm font-semibold">€</span>
            </div>
          </div>
          <div class="p-4 border-t border-b text-xs text-gray-700">
            <span class="flex items-center mb-1">
              <i class="far fa-clock fa-fw mr-2 text-gray-900"></i> {{$house->tage}} Tage
            </span>
            <span class="flex items-center">
              <i class="far fa-address-card fa-fw text-gray-900 mr-2"></i> {{$house->place}}
            </span>        
          </div>
